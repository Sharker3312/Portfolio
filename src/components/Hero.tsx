        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="mb-8">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 bg-clip-text text-transparent min-h-[1.2em]">
                  {typedText}
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              {/* Professional Photo */}
              <div className="relative w-80 h-80 rounded-full overflow-hidden border-4 border-gradient-to-r from-green-400 via-blue-500 to-purple-500 p-1 bg-gradient-to-r from-green-400 via-blue-500 to-purple-500">
              ...
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center animate-bounce delay-0 shadow-lg">
              ...
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center animate-bounce delay-1000 shadow-lg">
              ...
              <div className="absolute top-1/2 -left-8 w-14 h-14 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center animate-bounce delay-500 shadow-lg">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg" alt="Docker" className="w-7 h-7" />
              </div>
              
              <div className="absolute top-1/2 -right-8 w-14 h-14 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center animate-bounce delay-1500 shadow-lg">
