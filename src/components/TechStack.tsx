      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Herramientas y tecnologías que domino para construir soluciones robustas y escalables
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Eliminar tareas manuales repetitivas para aumentar la eficiencia
                </p>
              </div>
              ...
              <div>
                ...
                <h4 className="text-lg font-semibold text-white mb-2">Observabilidad</h4>
                <p className="text-gray-400 text-sm">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Infraestructura que crece con las necesidades del negocio
                </p>
              </div>
            </div>
          </div>
